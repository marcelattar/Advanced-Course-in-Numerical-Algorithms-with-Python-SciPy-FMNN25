...
if rank ==0:
    ...
    # Making a large mesh with all of the rooms
    allRooms = ones([MiddleRoom.meshH, leftRoom.meshW*3])*-100
    ...
    # Ploting the above mentioned mesh
